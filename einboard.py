...
def render_employee_dashboard():
    ...
    st.session_state.employee_data["num_employees"] = st.data_editor(
        st.session_state.employee_data["num_employees"], num_rows="dynamic"
    )
    ...
    st.session_state.employee_data["age_distribution"] = st.data_editor(
        st.session_state.employee_data["age_distribution"], num_rows="dynamic"
    )
    ...
    st.session_state.employee_data["marginalized"] = st.data_editor(st.session_state.employee_data["marginalized"])
    ...
    st.session_state.employee_data["pwd"] = st.data_editor(st.session_state.employee_data["pwd"])
    ...
    st.session_state.employee_data["women_leadership"] = st.data_editor(st.session_state.employee_data["women_leadership"])
    ...
    st.session_state.employee_data["employees_trained"] = st.data_editor(st.session_state.employee_data["employees_trained"])
    ...
    st.session_state.employee_data["benefits"] = st.data_editor(st.session_state.employee_data["benefits"])
...
# Other pages (Water, Waste, Biodiversity, Health & Safety, CSR, Board, Policies, Compliance, Risk Management) remain unchanged
