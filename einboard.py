...
if add_mode:
    selected_scope = st.sidebar.selectbox("Select Scope", ["Scope 1","Scope 2","Scope 3"])
...
# Main Dashboard
# ---------------------------
st.title("🌍 EinTrust GHG Emissions Dashboard")
...
if not df_log.empty:
    ...
    if df_cycle.empty:
        st.info("No entries in current Apr–Mar cycle yet.")
    else:
